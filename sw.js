...
const V = "plan-84c73cd8";
const FILES = ["./", "index.html?v=84c73cd8", "manifest.webmanifest?v=84c73cd8", "icon-192.png", "icon-512.png", "font-head.woff2?v=84c73cd8", "font-hand.woff2?v=84c73cd8"];
